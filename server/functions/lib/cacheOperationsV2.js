...
exports.getCacheMetricsV2 = exports.initializeCacheV2 = void 0;
...
exports.initializeCacheV2 = v2_1.https.onCall({
    ...
    if (!(userData === null || userData === void 0 ? void 0 : userData.isAdmin)) {
        throw new v2_1.https.HttpsError('permission-denied', 'Must be an admin to initialize cache');
    }
    try {
        ...
        throw new v2_1.https.HttpsError('internal', 'Failed to initialize cache');
    }
}));
exports.getCacheMetricsV2 = v2_1.https.onCall({
    cors: ['https://boardgameborrow.com', 'http://localhost:5174'],
    timeoutSeconds: 60,
    memory: "256MiB",
    minInstances: 0,
    ...
    try {
        ...
        throw new v2_1.https.HttpsError('internal', 'Failed to fetch cache metrics');
    }
}));
...
//# sourceMappingURL=cacheOperationsV2.js.map